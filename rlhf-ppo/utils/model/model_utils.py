...
def create_critic_model(model_name_or_path,
    ...
    # we load bloomz
    rlhf_training=False
    critic_model = create_hf_model(RewardModel, model_name_or_path, tokenizer,
                                   ds_config, rlhf_training, disable_dropout)
    critic_model.PAD_ID = tokenizer.pad_token_id
    critic_model.num_padding_at_beginning = 0
