...
class DeepSpeedRLHFEngine():
    ...
    def __init__(self, actor_model_name_or_path, critic_model_name_or_path,
        ...
        print_rank_0("loaded actor/critica models:", self.args.local_rank)
        print_rank_0(self.actor.module, self.args.local_rank)
        print_rank_0(self.critic.module, self.args.local_rank)
